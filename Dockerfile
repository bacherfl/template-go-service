...
WORKDIR /go/src/github.com/keptn/keptn/template-go-service
...
COPY --from=builder /go/src/github.com/keptn/keptn/template-go-service/template-go-service /template-go-service
